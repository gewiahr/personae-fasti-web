...
const RecordEdit = ({ record, closeModal, fullSuggestionData }: RecordEditProps) => {
  ...
  return (
    <div className="modal-overlay fixed inset-0 bg-black/50 flex justify-center items-center z-50" onClick={closeModal}>
      <div className="p-4 rounded-lg border border-blue-500 bg-gray-800 rounded-lg relative max-w-2xl w-[90%] mx-4 animate-in fade-in zoom-in-95 duration-300 ease-out" onClick={(e) => e.stopPropagation()}>
