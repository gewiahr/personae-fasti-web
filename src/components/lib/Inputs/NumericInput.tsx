...
type NumericInputComponentProps = NumericInputProps & {
  
};

export const NumericInput: React.FC<NumericInputComponentProps> = ({ label = '', value = 0, entityEdit, error, className = '' }) => {
